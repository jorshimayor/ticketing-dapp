...
// EventPOAP contract allows users to redeem a POAP (Proof of Attendance Protocol) NFT
...
contract EventPOAP is ERC721, Ownable {
    ...
    function redeemPOAP(uint256 ticketTokenId) external {
        ...
        require(msg.sender == ERC721(eventTicketContract).ownerOf(ticketTokenId), "Not ticket owner");
    ...
    function updateEventTicketContract(address newEventTicketContract) external onlyOwner {
